...
import { loadManagementScopeOptions } from './ManagementScopes';
	...
	methods = {
		loadOptions: {
			async getAccounts(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				return await loadManagementScopeOptions(this, 'ACCOUNT');
			},
			async getGroups(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				return await loadManagementScopeOptions(this, 'GROUP');
			},
			async getSites(this: ILoadOptionsFunctions): Promise<INodePropertyOptions[]> {
				return await loadManagementScopeOptions(this, 'SITE');
			},
		},
	};
