...
const builtScopes = join(packageRoot, 'dist/nodes/SentinelOne/ManagementScopes.js');
const sourceScopes = join(packageRoot, 'nodes/SentinelOne/ManagementScopes.ts');
